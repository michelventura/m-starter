 ...
 * @author Gary Jones
 */
class Mich_Starter_Search_Form {
	/**
	...
	public function __construct( array $strings = array() ) {
		$default_strings = array(
			...
			'label'        => apply_filters( 'genesis_search_form_label', __( 'Search site', 'mich-starter' ) ),
			// Placeholder should be empty: http://www.nngroup.com/articles/form-design-placeholders/.
			/** This filter is documented in genesis/lib/structure/search.php */
			'placeholder'  => apply_filters( 'genesis_search_text', __( '', 'mich-starter' ) ),
			/** This filter is documented in genesis/lib/structure/search.php */
			'button'       => apply_filters( 'genesis_search_button_text', __( 'Search', 'mich-starter' ) ),
			/**
			 ...
			 */
			'button_label' => apply_filters( 'genesis_search_button_label', __( 'Search', 'mich-starter' ) ),
		);
